...
class UpdateContactUseCase(private val contactRepository: IContactRepository) : BaseUseCase<Unit, ContactModel>() {

    override fun buildUseCaseObservable(params: ContactModel?): Flow<Unit> = contactRepository.updateContact(params!!)
